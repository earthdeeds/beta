      ...
      <script class="secret-source">
        jQuery(document).ready(function($) {
          ...
          $('#banner-slide').bjqs({
            ...
            <!--	<div class="sl"><a href="#"><img src="imageshome/sl.jpg" /></a></div>
                <div class="sl"><a href="#"><img src="imageshome/sl2.jpg" /></a></div>
                <div class="sl"><a href="#"><img src="imageshome/sl3.jpg" /></a></div>-->
            	<div class="clear">
            </div>
        </div><!-- Dulo of slider ---------------------------------------------------- -->
        </br>
        ...
        <div>
        	<div class="left">
            	...
            	<div class="video">			<iframe src="http://player.vimeo.com/video/63244295" width="513px" height="280px" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
            </div><!-- Dulo of left ---------------------------------------------------- --> 
            <div class="right">
                ...
                <br />
                <div>
                	<div class="test-pic"><img height="62px" width="62px" src="../projimageshome/Gaia%20School%20Asia%202.jpg" /></div>
                    <div class="testi">
                    	<div class="quote1"></div>
                        <p><span class="style3">I feel thankful for this donation and that others have faith in what we are doing. In addition to our reforestation work, some of the money will support a NextGEN empowerment training in northern Sri Lanka for 40 youth who will afterward take initiatives for positive change in their villages.  So this gift will keep giving!
                        </span>
                        <br />
                        </p>
                        <div style="text-align:right">
        ...
        <div>
       		<div class="left2" style="margin-left: 20px;">
                ...
                <br /><br />
				<?php 
						$resultteam = mysql_query("SELECT * FROM $tblteam where Team_account_idnum = '70' or Team_account_idnum = '75' or Team_account_idnum = '82'") or die(mysql_error());  
	...
	if ($rowteam['team_image'] == "teamimageshome/"){
       ...
       echo '         <div>
            ...
            <div class="left2">
            	...
            	<br /><br />
								<?php 
				$resultproj = mysql_query("SELECT * FROM $tblproject where project_account_idnum = '82' or project_account_idnum = '98' or project_account_idnum = '97'") or die(mysql_error());  
...
$projdesc = strip_tags($longdescproj);
	if ($rowproj['team_image'] == "projimageshome/"){
       ...
       echo '         <div>
                    '.$projimage.'
                    <div class="featured">
                        <span class="style3"><a href="http://beta.earthdeeds.com/project.php?projid='.$rowproj['project_account_idnum'].'">'.$rowproj['project_title'].'</a> '.substr($projdesc, 0, 150).'...</span>                
                    </div>
                    <div class="clear"></div>
                </div>
                <br />';
